    ...
    <footer className="bg-urban-black text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Shop */}
          <div>
            <h3 className="font-bold uppercase tracking-wider mb-4">Shop</h3>
            <ul className="space-y-2 text-sm">
              <li><a href="#clothing" className="text-gray-400 hover:text-white">Clothing</a></li>
              <li><a href="#shoes" className="text-gray-400 hover:text-white">Shoes</a></li>
              <li><a href="#caps" className="text-gray-400 hover:text-white">Caps</a></li>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="font-bold uppercase tracking-wider mb-4">Stay Updated</h3>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 bg-white text-black"
              />
              <button className="bg-white text-black px-4 py-2 font-bold hover:bg-gray-200">
                →
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2026 OBLIQUE-RUSTE. All rights reserved.
          </p>
